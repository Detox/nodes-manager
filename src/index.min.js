...
c;var d=h([a]);if(this.c.has(a)){var e=0;for(c=(b=Array.from(this.c.get(a))).length;e<c;++e){var f=b[e];d.add(f)}}b=[];c=Array.from(this.a.keys());for(e=0;7>e&&c.length;++e)(f=m(c))&&!d.has(f)&&b.push(f);var g=h();this.c.forEach(function(b,c){t(a,c)||b.forEach(function(a){d.has(a)||g.add(a)})});g=Array.from(g);e=0;for(f=Math.min(5,10-b.length);e<f&&g.length;++e)(c=m(g))&&b.push(c);return b},more_aware_of_nodes_needed:function(){return!!(this.a.size<this.j||this.m(!0).length)},m:function(a){null==
a&&(a=!1);var b=[];var c=+new Date-1E3*this.i;var d=!1;this.a.forEach(function(e,f){!d&&e<c&&(b.push(f),a&&!d&&(d=!0))});return b},get_nodes_for_routing_path:function(a,b){var c;null==b&&(b=[]);b=Array.from(this.f.values()).concat(b);var d=null!=(c=this.l(1,b))?c[0]:void 0;if(!d)return null;a=this.u(a-1,b.concat([d]));if(!a)return null;this.f.add(d);return[d].concat(a)},u:function(a,b){var c=[];if(this.a.size<a)return null;var d=Array.from(this.a.keys());if(b){var e=h(b);d=d.filter(function(a){return!e.has(a)})}if(d.length<
a)return null;for(b=0;b<a;++b)c.push(m(d));return c},del_first_node_in_routing_path:function(a){this.f["delete"](a)},destroy:function(){this.s||(this.s=!0,clearInterval(this.o))}};g.prototype=Object.assign(Object.create(k.prototype),g.prototype);Object.defineProperty(g.prototype,"constructor",{value:g});return g}var q=300;"function"===typeof define&&define.amd?define(["@detox/utils","async-eventer"],k):"object"===typeof exports?module.exports=k(require("@detox/utils"),require("async-eventer")):this.detox_nodes_manager=
