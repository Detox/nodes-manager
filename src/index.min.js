...
this.fire("connected_nodes_count",this.b.size)},set_peer:function(a,b){this.c.set(a,h(b))},set_aware_of_nodes:function(a,b){var c;var d=this.c.get(a);var e=0;for(c=b.length;e<c;++e){var f=b[e];if(d&&d.has(f)){this.fire("peer_warning",a);return}}a=this.m();e=0;for(c=b.length;e<c;++e)if(f=b[e],!this.b.has(f))if(this.a.has(f)||this.a.size<this.j)this.a.set(f,+new Date),this.fire("aware_of_nodes_count",this.a.size);else if(a.length)d=m(a),this.a["delete"](d),this.a.set(f,+new Date),this.fire("aware_of_nodes_count",
this.a.size);else break},get_aware_of_nodes:function(a){var b,c,d=this;var e=[];var f=Array.from(this.a.keys());for(b=0;10>b&&f.length;++b)(c=m(f))&&e.push(c);if(10>e.length){var g=h();this.c.forEach(function(b,c){t(a,c)||b.forEach(function(a){d.c.has(a)||g.add(a)})});g=Array.from(g);b=0;for(f=Math.min(5,10-e.length);b<f&&g.length;++b)(c=m(g))&&e.push(c)}return e},more_aware_of_nodes_needed:function(){return!!(this.a.size<this.j||this.m(!0).length)},m:function(a){null==a&&(a=!1);var b=[];var c=+new Date-
1E3*this.i;var d=!1;this.a.forEach(function(e,f){!d&&e<c&&(b.push(f),a&&!d&&(d=!0))});return b},get_nodes_for_routing_path:function(a,b){var c;null==b&&(b=[]);b=Array.from(this.f.values()).concat(b);var d=null!=(c=this.l(1,b))?c[0]:void 0;if(!d)return null;a=this.u(a-1,b.concat([d]));if(!a)return null;this.f.add(d);return[d].concat(a)},u:function(a,b){var c=[];if(this.a.size<a)return null;var d=Array.from(this.a.keys());if(b){var e=h(b);d=d.filter(function(a){return!e.has(a)})}if(d.length<a)return null;
for(b=0;b<a;++b)c.push(m(d));return c},del_first_node_in_routing_path:function(a){this.f["delete"](a)},destroy:function(){this.s||(this.s=!0,clearInterval(this.o))}};g.prototype=Object.assign(Object.create(k.prototype),g.prototype);Object.defineProperty(g.prototype,"constructor",{value:g});return g}var q=300;"function"===typeof define&&define.amd?define(["@detox/utils","async-eventer"],k):"object"===typeof exports?module.exports=k(require("@detox/utils"),require("async-eventer")):this.detox_nodes_manager=
k(this.detox_utils,this.async_eventer)}).call(this);